...
export function FeaturedProducts({ slotContext }: FeaturedProductsProps) {
  ...
  return (
    <View testID="featured-products" style={styles.container}>
      <View style={styles.header}>
        <Text style={[styles.title, { color: theme.colors.text }]}>
          Featured
        </Text>
        <Pressable testID="featured-see-all" onPress={slotContext?.onSeeAll}>
      ...
      <View testID="featured-products-grid" style={styles.grid}>
